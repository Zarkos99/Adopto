...
class UserProfileCreationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.auth_user_profile_creation_activity)
        ...
        done_button_view.setOnClickListener {
            ...
            // TODO: save biography to user database
            // TODO: save zip code to user database

            val intent =
                Intent(this@UserProfileCreationActivity, NavigationBaseActivity::class.java)
