 ...
 */
class AnimalProfileCreationImagesAdapter(
    private val context: Context,
    private val max_images: Int? = 5 // Set a maximum limit, null if no limit
) :
    RecyclerView.Adapter<AnimalProfileCreationImagesAdapter.ClickableViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClickableViewHolder {
        ...
        val view = LayoutInflater.from(context)
            .inflate(R.layout.animal_profile_creation_images_item, parent, false)
